...
smtpapi.prototype.jsonObject = function() {
  ...
  for (var key in this.header) {
    var isObject = (typeof this.header[key] === 'object' && Object.keys(this.header[key]).length);
    var headerHasKey = this.header[key]
    var isNumber = typeof this.header[key] === 'number' && headerHasKey;
    var isString = typeof this.header[key] === 'string' && headerHasKey;
    if (this.header.hasOwnProperty(key) && isObject ||
                                           isNumber ||
                                           isString) {
